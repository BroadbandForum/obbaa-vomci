    ...
    if gpbmsg.body.WhichOneof("msg_body") == "request":
        ...
        if gpbmsg.body.response.WhichOneof("resp_type") == "rpc_resp":
            ...
            if gpbmsg.body.response.hello_resp.service_endpoint_name == "voltmf":
                ...
                print("--------------------------------------")
                print("msg.body.response.hello_resp.service_endpoint_name=%s" % gpbmsg.body.response.hello_resp.service_endpoint_name)
                print("msg.body.response.hello_resp.network_function_info=\n%r" % gpbmsg.body.response.hello_resp.network_function_info)
                print("\n\n\n")
...
basic_consume_loop(consumer, ["VOMCI_RESPONSE"])
