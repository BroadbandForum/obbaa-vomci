...
empty = util.read_configuration('configurations/empty.json')
basic = util.read_configuration('configurations/basic.json')
upd_vlan = util.read_configuration('configurations/upd_vlan.json')
add_uni = util.read_configuration('configurations/add_uni.json')
two_uni = util.read_configuration('configurations/two_uni.json')
remove_uni = util.read_configuration('configurations/remove_uni_if.json')

vomci_msg.body.request.update_config.update_config_inst.current_config_inst = bytes(empty,"utf-8")
vomci_msg.body.request.update_config.update_config_inst.delta_config = bytes(basic, "utf-8")
