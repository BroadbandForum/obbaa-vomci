...
vomci_msg.header.recipient_name="vomci1"
...
#     "bbf-vomci:vomci":
#     { 
#        "vomci-msg-timeout": 20  
#     }
# }"
# """
#,"utf-8")

vomci_msg.body.request.replace_config.config_inst = bytes("{\"ietf-netconf-acm:nacm\":{},\"bbf-vomci-function:managed-onus\":{},\"bbf-vomci-function:vomci\":{}}"
    ,"utf-8")
